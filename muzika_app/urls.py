...
urlpatterns = [
    ...
    path("grojarasciai/kurti/", views.create_playlist_view, name="create_playlist"),
    path("grojarasciai/<int:playlist_id>/trinti/", views.delete_playlist_view, name="delete_playlist"),
    path("grojarasciai/<int:playlist_id>/prideti/<int:song_id>/", views.add_song_to_playlist_view, name="add_song_to_playlist"),
    path("grojarasciai/<int:playlist_id>/pasalinti/<int:song_id>/", views.remove_song_from_playlist_view, name="remove_song_from_playlist"),
    path("grojarasciai/mano.json", views.my_playlists_json_view, name="my_playlists_json"),
